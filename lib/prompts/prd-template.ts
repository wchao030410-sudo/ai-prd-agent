...
重要约束：
- 不要在输出中包含任何代码片段、代码示例或 Markdown 代码块
- 不要使用编程语言语法（如 JavaScript、Python 等）
- 所有内容使用自然语言描述
- 功能描述应该清晰易懂，不需要代码实现细节`;
...
重要约束：
- 所有字段内容必须使用自然语言描述
- 严禁包含任何代码片段、代码示例或编程语言语法
- 功能描述以用户视角描述"能做什么"，而非"如何实现"
- 验收标准使用可测试的业务语言，而非技术实现细节
- 技术可行性评估描述技术方向，但不包含具体代码
